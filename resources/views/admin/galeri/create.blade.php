...
<div class="card shadow-lg border-0 rounded-lg mt-5">
    <div class="card-header"><h3 class="text-center font-weight-light my-4">Create Galeri</h3></div>
    <div class="card-body">
    ...
    <input id="ket" type="text" class="form-control" name="ket" placeholder="Keterangan Galeri"><br>
...
<br> &nbsp; &nbsp; <button type="submit" class="btn btn-primary" name="submit" id="submit">Create Galeri</button><br>
</form>
</section>
@endsection